<?php
/**
 * Taxonomy Type Template
 *
 * This template can be overridden by copying it to yourtheme/fs-product-catalog/taxonomy-type.php
 *
...
<div class="fs-product-archive-container fs-product-taxonomy-type">
	<?php
	// Breadcrumbs.
	...
	<header class="fs-product-archive-header">
		<h1 class="fs-product-archive-title"><?php echo esc_html( $term->name ); ?></h1>
		<?php if ( ! empty( $term->description ) ) : ?>
			<div class="fs-product-archive-description"><?php echo wp_kses_post( wpautop( $term->description ) ); ?></div>
		<?php endif; ?>
	</header>
