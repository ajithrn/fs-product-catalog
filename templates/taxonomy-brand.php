 ...
 *
 * This template can be overridden by copying it to yourtheme/fs-product-catalog/taxonomy-brand.php
 *
...
<div class="fs-product-archive-container fs-product-taxonomy-brand">
	<?php
	// Breadcrumbs.
