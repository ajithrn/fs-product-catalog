 ...
 *
 * This template can be overridden by copying it to yourtheme/fs-product-catalog/taxonomy-category.php
 *
...
<div class="fs-product-archive-container fs-product-taxonomy-category">
	<?php
	// Breadcrumbs.
